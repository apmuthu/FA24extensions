...
page(_($help_context = "Manage Salary Schemes"));
...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM') {
	...
	elseif(strlen($_POST['amount']) == 0 || $_POST['amount'] == '') {
    	...
    	if ($selected_id != -1)
			display_notification(_('Selected salary scheme has been updated'));
    	else
			display_notification(_('New salary scheme has been added'));
...
text_row_ex(_('Salary Scheme Name').':', 'name', 37, 50);
